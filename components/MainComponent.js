...
import { View, Platform, StyleSheet, Text, ScrollView, Image,
    Alert, ToastAndroid } from 'react-native';import { createStackNavigator } from 'react-navigation-stack';
            ...
            navigationOptions: {
                drawerIcon: ({tintColor}) => (
                    <Icon
                        ...
                        type='font-awesome'
                        size={24}
                        color={tintColor} //color will change depending on active screen
                    />
                )
            }
        },
...
class Main extends Component {
        ...
        } //to stop listening to connection changes when main comp unmounts.
