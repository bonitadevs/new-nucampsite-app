//has all possible action objects that can be dispatched to reducers; including when we are loading data, adding data, and when fetching of data has failed
